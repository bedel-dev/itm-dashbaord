...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: FilterComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.ChangeDetectorRef }, { type: i1$2.I18nService }, { type: undefined, decorators: [{
                    type: Inject,
                    args: [TABLE_TH]
...
class DataTableComponent {
    ...
    resetThSortOrder() {
        merge(...this.thList?.map(th => th.sortChange)).pipe(takeUntil(this.thList.changes)).subscribe((sortEvent) => {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: DataTableComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.ElementRef }, { type: i0.NgZone }, { type: i0.Renderer2 }, { type: i0.ChangeDetectorRef }, { type: undefined, decorators: [{
                    type: Inject,
                    args: [DOCUMENT]
                }] }]; }, propDecorators: { checkable: [{
                type: Input
