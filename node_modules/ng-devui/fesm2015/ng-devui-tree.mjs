...
class TreeFactory {
    ...
    addNode(_a, index, renderTree = true) {
        var { id, parentId } = _a, data = __rest(_a, ["id", "parentId"]);
        let newId = id;
        if (isUndefined(id)) {
            this.idx++;
            newId = this.idx;
    ...
    mergeTreeNodes(targetNode = this.treeRoot) {
        const mergeToNode = (node) => {
            ...
            if (((_a = node.data.children) === null || _a === void 0 ? void 0 : _a.length) === 1 && ((_d = (_c = (_b = node.data.children[0]) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.children) === null || _d === void 0 ? void 0 : _d.length) !== 0) {
                node.data.title = node.data.title + ' / ' + ((_f = (_e = node.data.children[0]) === null || _e === void 0 ? void 0 : _e.data) === null || _f === void 0 ? void 0 : _f.title);
                node.data.children = (_h = (_g = node.data.children[0]) === null || _g === void 0 ? void 0 : _g.data) === null || _h === void 0 ? void 0 : _h.children;
                mergeToNode(node);
            }
            if (((_j = node.data.children) === null || _j === void 0 ? void 0 : _j.length) > 1) {
    ...
    transferToTreeNode(originNode, parentId, treeNodeChildrenKey = 'items', treeNodeIdKey = 'id', checkboxDisabledKey = 'disabled', selectDisabledKey = 'disableSelect', toggleDisabledKey = 'disableToggle', treeNodeTitleKey = 'title') {
        ...
        return new TreeNode(node.id, node.parentId, Object.assign({}, node));
    }
}
...
class TreeComponent {
    ...
    isSelectableRegion(ele) {
        ...
        if (ele && !ele.classList.contains('devui-tree-node__content--value-wrapper')
            ...
            && ((_a = ele.parentNode) === null || _a === void 0 ? void 0 : _a.tagName) !== 'D-HIGHLIGHT') {
            return false;
        }
        return true;
    }
                ...
                return this.postAddNode(treeNode)
                    ...
                    if (Object.prototype.hasOwnProperty.call(nodeInfo, 'data') && nodeInfo.data) {
                        if (Object.prototype.hasOwnProperty.call(treeNode, 'data') && Object.prototype.hasOwnProperty.call(treeNode.data, 'data')) {
                            treeNode.data.data = Object.assign(Object.assign({}, treeNode.data.data), nodeInfo.data);
                        }
                        else {
