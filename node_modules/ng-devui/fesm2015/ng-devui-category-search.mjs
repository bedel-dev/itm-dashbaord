...
class CategorySearchComponent {
    ...
    setCustomTemplate(data) {
        if ((data === null || data === void 0 ? void 0 : data.length) && this.category) {
    ...
    setI18nText() {
        ...
        this.i18n
            ...
            if (keyword) {
                ...
                keyword.title = `${keyword.label}:${(_a = keyword.value) === null || _a === void 0 ? void 0 : _a.label}`;
            }
        });
    }
    ...
    setSearchShow() {
        ...
        this.showSearchConfig = Object.assign(Object.assign({}, this.showSearchConfig), customConfig);
    }
    setSearchKeyTag() {
    ...
    scrollToTag(index, event) {
        var _a;
        const tags = (_a = this.scrollBarContainer) === null || _a === void 0 ? void 0 : _a.nativeElement.querySelectorAll('ul.devui-category-search-line>li');
        if (tags[index]) {
    ...
    updateFieldValue(field, value) {
        ...
        if (field.type === 'label') {
            if (!((_a = field.options[0]) === null || _a === void 0 ? void 0 : _a.$label)) {
    ...
    resetContent(dropdown, tag) {
        ...
        if (dropdown.isOpen) {
            ...
            if ((tag === null || tag === void 0 ? void 0 : tag.type) === 'keyword') {
