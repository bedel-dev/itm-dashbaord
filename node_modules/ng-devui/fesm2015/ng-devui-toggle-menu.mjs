...
class ToggleMenuContainerComponent {
    ...
    updateCdkConnectedOverlayOrigin() {
        var _a;
        if ((_a = this.selectWrapper) === null || _a === void 0 ? void 0 : _a.nativeElement) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: ToggleMenuContainerComponent, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: i1$2.WindowRef }, { type: i0.NgZone }, { type: i0.Renderer2 }, { type: i0.ChangeDetectorRef }, { type: i1$1.DevConfigService }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [DOCUMENT]
                    }] }];
...
class ToggleMenuLabelComponent {
    ...
    removeItem(item, event, index) {
        this.removeChange.emit(Object.assign(Object.assign({}, item), { event, index }));
    }
}
