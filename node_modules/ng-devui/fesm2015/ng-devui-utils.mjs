...
class PopperComponent {
    constructor(el, renderer, ngZone, changeDetectorRef, doc) {
        ...
        this.applyTransitionStyle = (data) => {
            ...
            this.updateContainerTransitionDirection((_c = (_b = (_a = data === null || data === void 0 ? void 0 : data.state) === null || _a === void 0 ? void 0 : _a.modifiersData) === null || _b === void 0 ? void 0 : _b.flip) === null || _c === void 0 ? void 0 : _c._skip);
            if (this.animate) {
