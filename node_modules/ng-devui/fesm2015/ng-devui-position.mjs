...
class PositionService {
    ...
    positionElements(hostElement, targetElement, placement, appendToBody) {
        ...
        if (Array.isArray(placement)) {
            ...
            placementPrimary = (placement === null || placement === void 0 ? void 0 : placement.split('-')[0]) || 'top';
            placementSecondary = (placement === null || placement === void 0 ? void 0 : placement.split('-')[1]) || 'center';
        }
...
PositioningModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: PositioningModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
PositioningModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: PositioningModule, imports: [WindowRefModule] });
PositioningModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: PositioningModule, providers: [PositionService], imports: [[WindowRefModule]] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: PositioningModule, decorators: [{
            type: NgModule,
            args: [{
...
//# sourceMappingURL=ng-devui-position.mjs.map
