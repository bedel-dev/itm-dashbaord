...
class DropDownService {
    ...
    closeDropdown(event) {
        ...
        const menuEl = (_a = this.openScope.menuEl) === null || _a === void 0 ? void 0 : _a.nativeElement;
        ...
        if (this.trigger === 'hover') {
            const states = merge(fromEvent(this.el.nativeElement, 'mouseenter').pipe(mapTo(true)), fromEvent(this.el.nativeElement, 'mouseleave').pipe(delay(200), filter((event) => {
                ...
                if (this.isOpen && this.appendToBody === true) {
                    ...
                    return !(((_a = this.menuEl) === null || _a === void 0 ? void 0 : _a.nativeElement) && relatedTarget &&
                        (((_c = (_b = this.menuEl) === null || _b === void 0 ? void 0 : _b.nativeElement.parentElement) === null || _c === void 0 ? void 0 : _c.contains(event.relatedTarget))
                            || ((_f = (_e = (_d = this.menuEl) === null || _d === void 0 ? void 0 : _d.nativeElement.parentElement) === null || _e === void 0 ? void 0 : _e.parentElement) === null || _f === void 0 ? void 0 : _f.contains(event.relatedTarget)) // 套了两层div增加判断
                            || ((_g = this.menuEl) === null || _g === void 0 ? void 0 : _g.nativeElement.contains(relatedTarget))
                            || this.dropdownChildren.some(children => {
                                var _a, _b, _c;
                                return children !== this
                                    // appendToBody的时候可能会没有实例化不在document上需要做判断有没有parentElement
                                    && (((_b = (_a = children.menuEl) === null || _a === void 0 ? void 0 : _a.nativeElement.parentElement) === null || _b === void 0 ? void 0 : _b.contains(event.relatedTarget))
                                        || ((_c = children.menuEl) === null || _c === void 0 ? void 0 : _c.nativeElement.contains(relatedTarget)));
                            })));
                }
                else {
                    return true;
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: DropDownDirective, decorators: [{
        ...
        return [{ type: DropDownService }, { type: i0.ChangeDetectorRef }, { type: i0.ElementRef }, { type: i2.DevConfigService }, { type: DropDownDirective, decorators: [{
                        type: Optional
                    }, {
                        type: SkipSelf
...
class DropDownMenuDirective {
    ...
    mouseLeave(event) {
        ...
        if ((this.dropdown.appendToBody && this.dropdown.trigger === 'hover')
            ...
            if (((_a = this.dropdown.toggleEl) === null || _a === void 0 ? void 0 : _a.nativeElement.contains(event.relatedTarget))
                || this.dropdown.dropdownChildren.some(children => {
                    var _a, _b;
                    return children.menuEl !== this.el
                        && ((_b = (_a = children.menuEl) === null || _a === void 0 ? void 0 : _a.nativeElement.parentElement) === null || _b === void 0 ? void 0 : _b.contains(event.relatedTarget));
                })) {
                return;
            }
                ...
                if (this.dropdown.trigger === 'hover') {
                    ...
                    if (relatedTarget && (((_b = this.dropdown.toggleEl) === null || _b === void 0 ? void 0 : _b.nativeElement.contains(relatedTarget))
                        || this.dropdown.dropdownChildren.some(children => { var _a; return (_a = children.menuEl) === null || _a === void 0 ? void 0 : _a.nativeElement.contains(relatedTarget); }))) {
                        return;
                    }
