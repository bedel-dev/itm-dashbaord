    ...
    constructor(renderer, windowRef, changeDetectorRef, i18n, ngZone, devConfigService, doc) {
       ...
       */
        ...
        this.getSelectedItem = () => {
            var _a;
            return ((_a = this.extraConfig) === null || _a === void 0 ? void 0 : _a.enableFocusFirstFilteredOption) && this.multiple && this.availableOptions.length
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: SelectComponent, decorators: [{
        ...
        return [{ type: i0.Renderer2 }, { type: i1.WindowRef }, { type: i0.ChangeDetectorRef }, { type: i2.I18nService }, { type: i0.NgZone }, { type: i3.DevConfigService }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [DOCUMENT]
                    }] }];
