...
class CascaderService {
    ...
    setCurrentValue() {
        this.currentValue = this.columnList.map(listItem => { var _a; return (_a = listItem.find(optionItem => optionItem.active)) === null || _a === void 0 ? void 0 : _a.value; });
    }
    updateOptionByValue() {
        var _a;
        this.resetNodeStatus();
        ...
        for (let index = 0; index < this.currentValue.length; index++) {
            const target = (_a = this.columnList[index]) === null || _a === void 0 ? void 0 : _a.find(listItem => listItem.value === this.currentValue[index]);
            if (target) {
                target['active'] = true;
...
class CascaderComponent {
    ...
    getMultipleValueFromValueList(valueList) {
        ...
        valueList.forEach(value => {
            ...
            for (let i = 0; i < value.length; i++) {
                ...
                if (this.isLazyLoad && cur && !((_a = cur.children) === null || _a === void 0 ? void 0 : _a.length) && !cur.isLeaf) {
    ...
    rePosition() {
        ...
        setTimeout(() => {
            ...
            const width = (_a = this.dropdownComp.overlay.overlayRef) === null || _a === void 0 ? void 0 : _a.overlayElement.clientWidth;
            const offsetX = (_b = this.dropdownComp.overlay.overlayRef) === null || _b === void 0 ? void 0 : _b.overlayElement.offsetLeft;
