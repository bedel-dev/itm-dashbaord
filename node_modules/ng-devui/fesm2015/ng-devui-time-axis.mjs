...
class TimeAxisItemComponent {
    ...
    */
    ...
    get horizontalNoLine() {
        var _a;
        return this.direction === 'horizontal' && ((_a = this === null || this === void 0 ? void 0 : this.lineStyle) === null || _a === void 0 ? void 0 : _a.style) === 'none';
    }
    get verticalNoLine() {
        var _a;
        return this.direction === 'vertical' && ((_a = this === null || this === void 0 ? void 0 : this.lineStyle) === null || _a === void 0 ? void 0 : _a.style) === 'none';
    }
    ngOnInit() {
    ...
    get timeAxisLineClass() {
        var _a;
        let styleClass = `devui-time-axis-line-style-${((_a = this.lineStyle) === null || _a === void 0 ? void 0 : _a.style) || 'solid'}`;
