...
class UploadComponent {
    ...
    dealOneTimeUploadFiles(uploads) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // 触发文件上传
            let finalUploads = [];
            yield uploads[0].send(uploads).finally(() => {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: SelectFiles, decorators: [{
        ...
        return [{ type: i1.I18nService }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [DOCUMENT]
                    }] }];
    } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: MultipleUploadComponent, decorators: [{
        ...
        return [{ type: SelectFiles }, { type: i1.I18nService }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [DOCUMENT]
...
class SingleUploadComponent {
    ...
    _dealFiles(observale) {
        observale
            ...
            this.checkValid();
            const file = (_a = this.singleUploadViewComponent.fileUploaders[0]) === null || _a === void 0 ? void 0 : _a.file;
            this.onChange(file);
            if (file) {
    ...
    isNeedChunk() {
        var _a;
        if ((_a = this.singleUploadViewComponent.fileUploaders[0]) === null || _a === void 0 ? void 0 : _a.file) {
    ...
    sliceUpload() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < fileUploaders.length; i++) {
                ...
                (yield uploadObservable).subscribe((results) => {
    ...
    uploadChunkList(fileChunkList, currentFile) {
        return __awaiter(this, void 0, void 0, function* () {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: SingleUploadComponent, decorators: [{
        ...
        return [{ type: i1.I18nService }, { type: SelectFiles }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [DOCUMENT]
                    }] }, { type: i3.ToastService }];
    }, propDecorators: { uploadOptions: [{
