...
import { ElementRef, EventEmitter, Injectable, Inject, Component, Directive, Input, Optional, Self, HostBinding, Output, QueryList, HostListener, NgModule } from '@angular/core';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: DraggableDirective, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: i0.Renderer2 }, { type: DragDropService }, { type: i0.NgZone }, { type: DragPreviewDirective, decorators: [{
                        type: Optional
                    }, {
                        type: Self
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: BatchDraggableDirective, decorators: [{
        ...
        return [{ type: DraggableDirective, decorators: [{
                        type: Self
                    }] }, { type: DragDropService }];
    }, propDecorators: { batchDragGroup: [{
                type: Input
            }], batchDragActive: [{
                type: Input
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: DragSyncDirective, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: DraggableDirective, decorators: [{
                        type: Optional
                    }, {
                        type: Self
                    }] }, { type: DragDropSyncService }, { type: DragDropService }, { type: DragSyncDescendantRegisterService }];
    }, propDecorators: { dragSyncGroup: [{
                type: Input,
                args: ['dDragSync']
            }] } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: DropScrollEnhancedDirective, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: i0.NgZone }, { type: DragDropService }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [DOCUMENT]
                    }] }];
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: DroppableDirective, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: i0.Renderer2 }, { type: DragDropService }, { type: i0.NgZone }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [DOCUMENT]
                    }] }];
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: DropSortSyncDirective, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: DroppableDirective, decorators: [{
                        type: Optional
                    }, {
                        type: Self
                    }] }, { type: DragDropSyncService }, { type: DropSortSyncDescendantRegisterService }];
    }, propDecorators: { dropSyncGroup: [{
                type: Input,
                args: ['dDropSortSync']
            }], direction: [{
                type: Input,
