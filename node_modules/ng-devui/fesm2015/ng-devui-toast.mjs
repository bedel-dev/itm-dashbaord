...
class ToastComponent {
    ...
    handleValueChange() {
        ...
        setTimeout(() => this._value.forEach((v, i) => { var _a; return v && ((_a = doms[i]) === null || _a === void 0 ? void 0 : _a.classList.add('slide-in')); }));
        if (!this.sticky) {
            if (this.timeout) {
    ...
    interrupt(index, msgItem) {
        ...
        if (this.lifeMode === 'single') {
            ...
            this.resetDelay(() => {
                ...
                const doms = this.container.children;
                otherToasts.forEach((v, i) => { var _a; return v && ((_a = doms[i]) === null || _a === void 0 ? void 0 : _a.classList.remove('slide-in')); });
            });
        }
    }
    resetDelay(fn) {
    ...
    removeAll() {
        if (this.value && this.value.length) {
            const doms = this.container.children;
            this._value.forEach((v, i) => { var _a; return v && ((_a = doms[i]) === null || _a === void 0 ? void 0 : _a.classList.remove('slide-in')); });
            setTimeout(() => {
...
class ToastService {
    ...
    component, componentFactoryResolver, } = {}) {
        ...
        toastRef.instance.onHidden = () => {
            if (toastRef === null || toastRef === void 0 ? void 0 : toastRef.hostView) {
