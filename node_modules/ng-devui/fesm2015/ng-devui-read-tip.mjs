...
class ReadTipDirective {
    ...
    onMouseOver(event) {
        var _a;
        this.findElementIndex(event.target, (_a = this.readTipOptions) === null || _a === void 0 ? void 0 : _a.rules, 'hover').subscribe((elementInfo) => {
            var _a, _b;
            if (elementInfo === null || elementInfo === void 0 ? void 0 : elementInfo.shouldTrigger) {
                this.hide();
                if (!this.readTipComponentRef) {
                    const target = new ElementRef(event.target);
                    setTimeout(() => {
                        this.show(target, elementInfo.rule);
                    }, (_a = elementInfo.rule) === null || _a === void 0 ? void 0 : _a.mouseenterTime);
                }
                if (this.readTipComponentRef) {
                    setTimeout(() => {
                        if (this.readTipComponentRef) {
                    ...
                    }, (_b = elementInfo.rule) === null || _b === void 0 ? void 0 : _b.mouseenterTime);
                }
            }
        });
    }
    onMouseOut(event) {
        ...
        this.findElementIndex(event.target, (_a = this.readTipOptions) === null || _a === void 0 ? void 0 : _a.rules, 'hover').subscribe((elementInfo) => {
            ...
            if (elementInfo === null || elementInfo === void 0 ? void 0 : elementInfo.shouldTrigger) {
                setTimeout(() => {
                    this.hide();
                }, (_a = elementInfo.rule) === null || _a === void 0 ? void 0 : _a.mouseleaveTime);
            }
        });
    }
    onClick(event) {
        var _a;
        this.findElementIndex(event.target, (_a = this.readTipOptions) === null || _a === void 0 ? void 0 : _a.rules, 'click').subscribe((elementInfo) => {
    ...
    findElementIndex(element, rules, trigger) {
        ...
        if (rules instanceof Array) {
            ...
            return of({
                shouldTrigger: ((_a = rules[elementIndex]) === null || _a === void 0 ? void 0 : _a.trigger) === trigger && this.isCorrectElement((_b = rules[elementIndex]) === null || _b === void 0 ? void 0 : _b.selector, element),
            ...
            return of({
                shouldTrigger: (rules === null || rules === void 0 ? void 0 : rules.trigger) === trigger && this.isCorrectElement(rules === null || rules === void 0 ? void 0 : rules.selector, element),
                rule: rules,
            });
        }
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: ReadTipDirective, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: i0.ComponentFactoryResolver }, { type: i1$1.OverlayContainerRef }, { type: i0.Injector }, { type: i0.ViewContainerRef }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [DOCUMENT]
                    }] }];
