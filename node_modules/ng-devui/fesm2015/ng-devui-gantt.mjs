...
class GanttToolsComponent {
    ...
    ngOnInit() {
        ...
        this.i18nSubscription = this.i18n.langChange().subscribe((data) => {
            ...
            this.views = [
                {
                    label: (_a = this.i18nText) === null || _a === void 0 ? void 0 : _a.day,
                    value: 'day'
                },
                {
                    label: (_b = this.i18nText) === null || _b === void 0 ? void 0 : _b.week,
                    value: 'week'
                },
                {
                    label: (_c = this.i18nText) === null || _c === void 0 ? void 0 : _c.month,
                    value: 'month'
                }
            ];
        });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: ResizeHandleDirective, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: i0.Renderer2 }, { type: i0.NgZone }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [DOCUMENT]
                    }] }];
