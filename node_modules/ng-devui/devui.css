...
.devui-dropdown.devui-dropdown-open .devui-dropdown-toggle span.icon-chevron-down, .devui-dropdown.devui-dropdown-open .devui-dropdown-toggle span.icon-select-arrow {
...
.devui-dropdown-menu {
  ...
  box-shadow: var(--devui-shadow-connected-overlay, 0 2px 8px 0) var(--devui-shadow, rgba(37, 43, 58, 0.2));
  list-style: none;
  outline: none;
}
.devui-dropdown-menu.devui-scrollbar,
.devui-dropdown-menu .devui-scrollbar {
  overflow-y: auto;
  overflow-y: overlay;
}
...
.devui-dropdown-menu .devui-dropdown-item {
  ...
  border-radius:  2px;
  border-radius: var(--devui-border-radius, 2px);
  transition: color  100ms  cubic-bezier(0.645, 0.045, 0.355, 1), background-color  100ms  cubic-bezier(0.645, 0.045, 0.355, 1);
  transition: color var(--devui-animation-duration-fast, 100ms) var(--devui-animation-ease-in-out-smooth, cubic-bezier(0.645, 0.045, 0.355, 1)), background-color var(--devui-animation-duration-fast, 100ms) var(--devui-animation-ease-in-out-smooth, cubic-bezier(0.645, 0.045, 0.355, 1));
}
.devui-dropdown-menu .devui-dropdown-item:not(:first-child) {
  margin-top: 4px;
}
.devui-dropdown-menu .devui-dropdown-item.disabled {
  cursor: not-allowed;
  color:  #cfd0d3;
  color: var(--devui-disabled-text, #cfd0d3);
}
.devui-dropdown-menu .devui-dropdown-item:not(.disabled):hover:not(.selected):not(.active) {
...
.devui-dropdown-menu .devui-dropdown-item:not(.disabled).selected, .devui-dropdown-menu .devui-dropdown-item:not(.disabled).active {
  color:  #252b3a;
  color: var(--devui-list-item-active-text, #252b3a);
  background-color:  #f2f5fc;
  background-color: var(--devui-list-item-active-bg, #f2f5fc);
}
.devui-dropdown-menu .devui-dropdown-item:not(.disabled).selected:hover, .devui-dropdown-menu .devui-dropdown-item:not(.disabled).active:hover {
  background-color:  #f2f5fc;
  background-color: var(--devui-list-item-active-bg, #f2f5fc);
  color:  #252b3a;
  color: var(--devui-list-item-active-text, #252b3a);
...
[dTextarea] {
  ...
  transition: border-color 300ms var(--devui-animation-ease-in-out-smooth, cubic-bezier(0.645, 0.045, 0.355, 1));
}
...
.devui-form-controls textarea[disabled], .devui-form-controls textarea[disabled]:hover, .devui-form-controls textarea.disabled, .devui-form-controls textarea.disabled:hover, .devui-form-controls textarea.devui-disabled, .devui-form-controls textarea.devui-disabled:hover,
[dTextInput][disabled],
...
.devui-input[disabled], .devui-input[disabled]:hover, .devui-input[disabled]:focus, .devui-input[disabled]:hover:focus, .devui-input.disabled, .devui-input.disabled:hover, .devui-input.disabled:focus, .devui-input.disabled:hover:focus, .devui-input.devui-disabled, .devui-input.devui-disabled:hover, .devui-input.devui-disabled:focus, .devui-input.devui-disabled:hover:focus {
  border-color:  #dfe1e6;
  border-color: var(--devui-disabled-line, #dfe1e6);
  color:  #cfd0d3;
  color: var(--devui-disabled-text, #cfd0d3);
...
.devui-dropdown-origin:not(d-button):not(.icon):not([class^=icon-])[disabled] > .devui-dropdown-default:focus, .devui-dropdown-origin:not(d-button):not(.icon):not([class^=icon-]).disabled .devui-form-control,
.devui-dropdown-origin:not(d-button):not(.icon):not([class^=icon-]).disabled .devui-form-control:hover,
.devui-dropdown-origin:not(d-button):not(.icon):not([class^=icon-]).disabled .devui-form-control:focus,
.devui-dropdown-origin:not(d-button):not(.icon):not([class^=icon-]).disabled .devui-form-control:focus:hover,
.devui-dropdown-origin:not(d-button):not(.icon):not([class^=icon-]).disabled .devui-input-group-addon,
...
.devui-dropdown-origin:not(d-button):not(.icon):not([class^=icon-]).disabled > .devui-dropdown-default:hover,
.devui-dropdown-origin:not(d-button):not(.icon):not([class^=icon-]).disabled > .devui-dropdown-default:active,
.devui-dropdown-origin:not(d-button):not(.icon):not([class^=icon-]).disabled > .devui-dropdown-default:focus, .devui-dropdown-origin:not(d-button):not(.icon):not([class^=icon-]).devui-disabled .devui-form-control,
...
.devui-icon-spin {
  animation: devuiSpin 2.5s linear infinite;
}
...
.devui-icon-diffusion {
  border-radius: 50%;
  animation: devuiDiffusion 0.4s cubic-bezier(0.5, 0.05, 0.5, 0.95) 1;
}

@keyframes devuiDiffusion {
  0% {
    box-shadow: rgba(37, 43, 58, 0.3) 0 0 0 0;
  }
  100% {
    box-shadow: rgba(37, 43, 58, 0) 0 0 0 4px;
  }
}
.devui-icon-rotate {
